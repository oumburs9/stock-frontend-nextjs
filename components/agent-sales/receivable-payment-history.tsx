...
import { useReceivablePayments } from "@/lib/hooks/use-finance"
...
export function ReceivablePaymentHistory({ receivableId }: ReceivablePaymentHistoryProps) {
  const { data: payments = [], isLoading } = useReceivablePayments(receivableId)
