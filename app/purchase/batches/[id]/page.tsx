...
export default function BatchDetailPage() {
  ...
  //   quantity_remaining: "85.00",
  //   base_unit_cost: "15.50",
  //   landed_unit_cost: "17.25",
  //   received_at: "2024-01-15",
  //   expenses: [
  //     {
  //       id: "1",
  //       batch_id: id,
  //       expense_type_id: "exp-freight",
  //       type: "FREIGHT",
  //       amount: "150.00",
  //       description: "Sea freight charges from supplier warehouse",
            ...
            <CardContent>
              {!displayBatch?.expenses || displayBatch?.expenses.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <Button variant="link" onClick={() => setAddExpenseOpen(true)} className="mt-2">
