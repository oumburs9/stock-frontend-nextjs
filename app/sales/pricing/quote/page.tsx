...
export default function PriceQuotePage() {
  ...
  return (
    <DashboardLayout>
      <RequirePermission permission="pricing-quote:view">
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => refetch()} disabled={!hasPermission("pricing-quote:view") || !selectedProductId || isLoading} className="w-full">
